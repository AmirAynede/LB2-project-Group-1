...
|-----------|----------------|----------------|----------------|
| Positive  | 2,932          | 1,093            | [cluster-results-pos_rep_seqs.fasta](data_split/files/cluster_output/cluster-results-pos_rep_seqs.fasta)
| Negative  | 20,615         | 8,934            | [cluster-results-neg_rep_seqs.fasta](data_split/files/cluster_output/cluster-results-neg_rep_seqs.fasta)
